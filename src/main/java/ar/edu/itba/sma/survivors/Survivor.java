...
import ar.edu.itba.sma.survivors.frontend.GameUI;
import ar.edu.itba.sma.survivors.frontend.MenuUI;
...
public class Survivor extends ApplicationAdapter {
    ...
    public static final String spriteSheet = "assets/spriteSheet-big.png";
